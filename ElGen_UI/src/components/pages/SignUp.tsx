    ...
    return (
        <div className='sign-up'>
            ...
            <form className='input-box' onSubmit={(e) => e.preventDefault()}>
                ...
                <PasswordInput autoComplete='on' placeholder='Password' inputName='text-input' id='password-input'/>
                <PasswordInput autoComplete='on' placeholder='Confirm password' inputName='text-input' id='password-confirm'/>
